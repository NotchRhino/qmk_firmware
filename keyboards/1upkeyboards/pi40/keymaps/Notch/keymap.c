...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_ONE] =  LAYOUT_ortho_4x12 (
        ...
        KC_LCTL, MO(3),   KC_LALT, KC_LGUI, MO(1), KC_SPC,  KC_SPC,   MO(2),   KC_LEFT,  KC_DOWN,   KC_UP, KC_RGHT
    ),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [_ONE]   =  { ENCODER_CCW_CW(KC_VOLU, KC_VOLD) },
    [_TWO]   =  { ENCODER_CCW_CW(RGB_MOD,  RGB_RMOD) },
    [_THREE] =  { ENCODER_CCW_CW(RGB_MOD,  RGB_RMOD) },
    [_FOUR]  =  { ENCODER_CCW_CW(RGB_VAI,  RGB_VAD) }
};
#endif
